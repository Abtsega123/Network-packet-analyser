    ...
    while True:
        ...
        if eth_proto == 8:
            ...
            #TCP
                ...
                (src_port, dest_port, sequence, acknowledgment, flag_urg, falg_ack, flag_psh, flag_rst, flag_syn, flag_fin, data[offset:], ofset_reserved_flags)
                print(TAB_1 + 'TCP Segment:')
                print(TAB_2 + 'Source Port: {}, Destination Port: {}'.format(src_port, dest_port))
                print(TAB_2 + 'Sequence: {}, Acknowledgment: {}'.format(sequence, acknowledgment))
                print(TAB_2 + 'URG: {}, ACK: {}, PSH: {}, RST: {}, SYN: {}, FIN: {}'.format(flag_urg, falg_ack, flag_psh, flag_rst, flag_syn, flag_fin))
                print(TAB_2 + 'Flags:')
                print(TAB_2 + 'Data')
                print(format_multi_line(DATA_TAB_3))
                ...
                print(TAB_1 + 'Protocol: {}'.format(proto))
